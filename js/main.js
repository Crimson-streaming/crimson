...
const video = document.getElementById("player");
    ...
    // Fonction pour capturer les couleurs dominantes de la vidéo
    function updateAmbilight() {
      // Taille du canvas réduite pour les performances
      ...
      // Applique la couleur dominante à l'ambilight
      ambilight.style.backgroundColor = `rgb(${r}, ${g}, ${b})`;
    }
    
    // Met à jour les couleurs pendant la lecture
